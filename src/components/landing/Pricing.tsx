              ...
              >
                {isPro && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="bg-gradient-to-b from-white/20 to-white/10 text-white text-[11px] font-semibold px-4 py-1.5 rounded-full flex items-center gap-1.5 border border-white/15">
                ...
                <div className="flex items-center gap-2.5 mb-4">
                  <div className={`w-9 h-9 rounded-[10px] flex items-center justify-center ${isPro ? "bg-white/[0.08]" : "bg-white/[0.04]"}`}>
                    <Icon className={`w-4 h-4 ${isPro ? "text-white/60" : "text-white/30"}`} />
                  </div>
                ...
                <ul className="mt-8 space-y-3 flex-1">
                  {features.map((feature: string) => (
                    <li key={feature} className="flex items-start gap-3">
                      <div className={`w-5 h-5 rounded-full flex items-center justify-center mt-0.5 shrink-0 ${isPro ? "bg-white/[0.08]" : "bg-white/[0.04]"}`}>
                        <Check className={`w-3 h-3 ${isPro ? "text-white/60" : "text-white/30"}`} />
                      </div>
                ...
                <a
                  ...
                  className={`mt-8 block text-center py-3.5 rounded-full font-medium text-[14px] transition-all duration-300 ${
                    isPro
                      ? "bg-gradient-to-b from-white/20 to-white/5 text-white border border-white/15 hover:from-white/25 hover:to-white/10"
